...
# plt.suptitle("Santiago sin AVO calles y con zonas seleccionadas")
...
# plt.savefig("Santiago sin AVO calles y con zonas seleccionadas", dpi = 300, bbox_inches = 'tight')
...
# plt.suptitle("Grafo Santiago sin AVO")
...
# plt.savefig("Grafo Santiago sin AVO", dpi = 300, bbox_inches = 'tight')
...
# 	plt.suptitle(f"Grafo Santiago sin AVO {coordenadas}")

# 	pos = nx.get_node_attributes(G, "pos")
# 	nx.draw(G, pos = pos, ax = ax, with_labels=False, font_weight = 50, font_size=2, width=0.2, node_size=3, arrowsize=6, edge_color="red")
	
# 	plt.savefig(f"Grafo Santiago sin AVO parte {coordenadas}", dpi = 300, bbox_inches = 'tight')
...
for i in zonas_a_graficar:
	...
	plt.suptitle(f"Grafo Flujo Santiago sin AVO {coordenadas}")
	...
	plt.savefig(f"Grafo Flujo Santiago sin AVO parte {coordenadas}", dpi = 300, bbox_inches = 'tight')
...
for i in zonas_a_graficar:
	...
	plt.suptitle(f"Grafo Costo Santiago sin AVO {coordenadas}")
	...
	plt.savefig(f"Grafo Costo Santiago sin AVO parte {coordenadas}", dpi = 300, bbox_inches = 'tight')
